...
* Python **[3.11.1](https://docs.python.org/)**, installed via [pyenv](https://github.com/pyenv/pyenv).
...
| ------- | ----------- | ----- |
| `foobar_db` | database for main application | `postgres` |
...
| `0` | Not used |
| `1` | Celery broker |
| `2` | Direct usage with [`redis_client`](./api/foobar/apps/common/utils/redis.py#L9) function in main application |
| `3` - `15` | Not used |
