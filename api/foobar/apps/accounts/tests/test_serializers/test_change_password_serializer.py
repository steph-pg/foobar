...
from foobar.apps.accounts.api.v1.serializers.password import ChangePasswordSerializer
from foobar.apps.accounts.exceptions import InvalidPasswordError, WrongPasswordError
