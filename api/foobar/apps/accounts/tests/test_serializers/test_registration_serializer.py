...
from foobar.apps.accounts.api.v1.serializers.registration import RegistrationSerializer
from foobar.apps.accounts.exceptions import InvalidPasswordError
