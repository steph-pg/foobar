...
from foobar.apps.accounts.api.v1.views.login import LoginView, LogoutView
from foobar.apps.accounts.api.v1.views.password import (
    ChangePasswordAPIView,
    ConfirmResetPasswordAPIView,
    ResetPasswordAPIView,
)
from foobar.apps.accounts.api.v1.views.registration import RegistrationAPIView
from foobar.apps.accounts.api.v1.views.user_profile import UserProfileAPIView
