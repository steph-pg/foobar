...
api_v1_urlpatterns = [
    path(
        ...
        include(("foobar.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    )
]
...
# enable Swagger
if "SWAGGER" in settings.FOOBAR_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="foobar",
            default_version="v1",
            description="foobar API v1 description",
        ),
        public=True,
